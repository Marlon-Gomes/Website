...
\talktitle{Scalar curvature, conformal geometry, and Einstein metrics.}
%\affiliation{Replace by your university, affiliation or organization}

\begin{abstract}
In this introductory talk, I will describe how scalar curvature manifests itself in Riemannian Geometry, from a variational perspective. We will study properties of extrema of the Einstein-Hilbert functional, and its restriction to conformal classes of Riemannian metrics. We will finish with a brief discussion of the Yamabe problem.
\end{abstract}
