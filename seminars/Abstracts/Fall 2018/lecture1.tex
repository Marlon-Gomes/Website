...
\speaker{Lisandra Hernandez}
\talktitle{Introduction to Einstein manifolds}
%\affiliation{Replace by your university, affiliation or organization}

\begin{abstract}
The goal of the talk is to provide an introduction to Esintein metrics which focueses on dicsussing several examples and a few topological obstructions in dimensions 3 and 4. 
\end{abstract}
